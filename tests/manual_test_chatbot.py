...
SURVEY_ALREADY_COMPLETED_MESSAGE = "You have already completed this survey"
            ...
            async with websockets.connect(WEBSOCKET_URL) as websocket:
                ...
                while True:
                    try:
                        ...
                        # Check if the server sent "Survey already completed"
                        if SURVEY_ALREADY_COMPLETED_MESSAGE in message:
                            print("You have already completed this survey. Closing connection.")
                            return  # End the manual test
